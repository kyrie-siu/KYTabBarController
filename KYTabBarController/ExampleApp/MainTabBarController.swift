...
class MainTabBarController: KYTabBarController {
    ...
    override func viewDidLoad() {
        ...
        let routeTabBarItem = KYTabBarItem.init(KYTabBarItemLottieContentView(animationName: "tab_route_dark", placeholderImage:#imageLiteral(resourceName: "menu")), title: "Route", tag: 0)
        ...
        //        let evemtstabBarItem = KYTabBarItem.init(KYTabBarItemImageContentView(image: #imageLiteral(resourceName: "menu"), selectedImage: #imageLiteral(resourceName: "menu")), title: "Events", tag: 0)
        let ycTabBarItem = KYTabBarItem.init(KYTabBarItemLottieContentView(animationName: "tab_yc_dark", placeholderImage:#imageLiteral(resourceName: "menu")), title: "YC", tag: 0)
        ...
        //        let evemtstabBarItem = KYTabBarItem.init(KYTabBarItemImageContentView(image: #imageLiteral(resourceName: "menu"), selectedImage: #imageLiteral(resourceName: "menu")), title: "Events", tag: 0)
        let settingsTabBarItem = KYTabBarItem.init(KYTabBarItemLottieContentView(animationName: "tab_settings_dark", placeholderImage:#imageLiteral(resourceName: "menu")), title: "Settings", tag: 0)
